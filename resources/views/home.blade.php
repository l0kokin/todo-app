    ...
    <div class="flex">
        ...
        <div class="flex min-h-full flex-col justify-center mx-20 w-1/2 relative">
            ...
            <form class="space-y-6 mt-10 sm:mx-auto sm:w-full sm:max-w-sm" action="#" method="POST">
                <div>
                    <label for="email" class="block text-sm/6 font-medium text-gray-900">@lang('auth.email')</label>
                    <div class="mt-2">
                ...
                <div>
                    <div class="flex items-center justify-between">
                        <label for="password" class="block text-sm/6 font-medium text-gray-900">@lang('auth.password')</label>
                        <div class="text-sm">
                        </div>
                    </div>
                    <div class="mt-2">
                ...
                <div>
                    <x-button-white type="submit" class="uppercase bg-blue hover:bg-blue-darker text-white w-full flex justify-center">@lang('auth.welcome')</x-button-white>
                </div>
            </form>
